...
class MeasuringWidget extends React.Component<IProps, IState> {
  ...
  render() {
    const nearest = this.nearMeasuring(this.props.measuring);
    return (
      <TouchableOpacity
  ...
  private nearMeasuring(medications: Measuring[]) : EventTime[] {
    const med: EventTime[] = [];
    let m: EventTime;
    let n = 0, t = 0, i = 0;
...
const mapState = (state: RootState) => ({
  measuring: state.measurings.list
});
...
export default connector(MeasuringWidget);